...
3. Create the Target Object
   ...
   Select the Target, add a Material, and change the color. (if needed) # Ex.No: 4  Implementation of Kinematic movement -seek and Flee behavior in Unity
### DATE:24/07/2026                                                                            
